...
const Pagination: FC<PaginationProps> = ({
  ...
  // Add debug output
  console.log(`Pagination debug: total=${totalItems}, limit=${limit}, totalPages=${Math.ceil(totalItems / limit)}`);  
  return pageButtons;
};
  console.log(`Pagination debug: total=${safeTotal}, limit=${safeLimit}, totalPages=${totalPages}`);
  return (
    <div className="flex justify-between items-center p-4 border-t" style={{fontFamily: 'Montserrat, sans-serif'}}>
